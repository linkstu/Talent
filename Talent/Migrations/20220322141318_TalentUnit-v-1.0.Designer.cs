...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Talent.Models.Service", b =>
                {
                    b.HasOne("Talent.Models.ServiceCategory", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Talent.Models.TalentUnit", b =>
                {
                    b.HasOne("Talent.Models.IndustryCategory", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Talent.Models.TalentUnitDocument", b =>
                {
                    ...
                    b.HasOne("Talent.Models.TalentUnit", "TalentUnit")
                        .WithMany("Documents")
                        .HasForeignKey("TalentUnitID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("File");

                    b.Navigation("TalentUnit");
                });
